...
public class PolygonObject {
    ...
    public UVN4x4 camera = new UVN4x4();
    ...
    public static PolygonObject transformObject(PolygonObject po, Matrix4x4 m) {
        PolygonObject newObject = new PolygonObject();
        for (Vector4 v : po.vertices) {
            Vector4 newVertex = Matrix4x4.times(m, v);
            newObject.vertices.add(newVertex);
        }
        return newObject;
    }
